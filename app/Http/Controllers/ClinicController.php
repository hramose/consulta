...
class ClinicController extends Controller
{
    ...
    public function index()
    {
       ...
       if(request()->all())
       {
            if(trim(request('q')) != '' || request('province') != '' || request('canton') != '' || request('district') != '' || request('lat') != '' || request('lon') != ''){
                ...
                return view('user.search.clinics.index',compact('clinics','search'));
            }
        }

        return view('user.search.clinics.index',compact('clinics'));
    ...
    public function schedule($office_id)
    {
       ...
       // if(!$medic->hasrole('medico')) return redirect('/');
        ...
        return view('user.search.clinics.schedule',compact('medics','medic','office'));
    }
