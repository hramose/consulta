        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="box">
              ...
              <form action="/pharmacy/patients" method="GET">
                <div class="form-group">
                    <div class="col-sm-2">
                      <a href="{{ url('/pharmacy/patients/create') }}" class="btn btn-success">Crear Nuevo paciente</a>
                    </div>
                  ...
                  @foreach($patients as $patient)
                    <tr>
                      ...
                      <td data-title="Nombre">
                        ...
                        <a href="{{ url('/pharmacy/patients/'.$patient->id.'/edit') }}" title="{{ $patient->first_name }}">{{ $patient->first_name }} {{ $patient->last_name }}</a>
                      ...
                      <td data-title="" style="padding-left: 5px;">
                        ...
                        <div class="btn-group">
                          <a href="{{ url('/pharmacy/patients/'.$patient->id.'/edit') }}" class="btn btn-info" title="Editar Paciente"><i class="fa fa-edit"></i></a>
                          
                          @if($patient->phone)
                            <button type="submit" class="btn btn-success" form="form-share-link" formaction="{!! url('/pharmacy/patients/'.$patient->id.'/share/link') !!}" title="Compartir Link">Compartir link APP</button>
                          @endif
                          <!--<button type="button" class="btn btn-default"><i class="fa fa-align-center"></i></button>-->
                           @if(!$patient->appointments->count() && $patient->isPatientOf(auth()->user()))
                            <button type="submit" class="btn btn-danger" form="form-delete" formaction="{!! url('/pharmacy/patients/'.$patient->id) !!}" title="Eliminar Paciente"><i class="fa fa-remove"></i></button>
                          @endif
                        </div>
