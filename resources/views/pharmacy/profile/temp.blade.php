@extends('layouts.app-pharmacy-temp')
@section('css')
...
@section('content')
                      ...
                      <li class="item">
                        ...
                        <div class="medic-info">
                          <a href="javascript:void(0)" class="medic-title">{{ $doctor->name }}
                            <span class="label {{ ($doctor->verifypharmacy($pharmacy->id)) ? 'label-info' : 'label-danger'}} pull-right">{{ ($doctor->verifypharmacy($pharmacy->id)) ? 'Registrado' : 'Pendiente' }}</span></a>
            ...
            <div class="box-body no-padding">
              <div class="register-box">
                ...
                <div class="register-box-body">
                  <p class="login-box-msg">Registra una nueva cuenta como Farmacia para modificar datos</p>

                  <form  role="form" method="POST" action="{{ url('/pharmacy/register') }}">
                      {{ csrf_field() }}
                      <input id="pharmacy" type="hidden" name="pharmacy" value="{{ $pharmacy->id }}">
    ...
    @if(isset($p))
      ...
      @else
         <modal-clinic-appointments :pharmacy="{{ $pharmacy->id }}"></modal-clinic-appointments>
      @endif
