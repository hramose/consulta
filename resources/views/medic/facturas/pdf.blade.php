...
@section('content')
 <section class="content">
    ...
    <section class="invoice">
      <form action="/medic/facturas/{{ $factura->id }}/pdf" method="POST" id="form-generate-pdf">
       ...
       @include('medic/facturas/partials/invoicePDF')

      <!-- this row will not appear when printing -->
      <div class="row no-print">
        <div class="col-xs-12">
          <a href="#" target="_blank" class="btn btn-default" onclick="printSummary();"><i class="fa fa-print"></i> Imprimir</a>
          <!-- <a href="/medic/appointments/{{ $factura->appointment->id}}/edit" class="btn btn-success pull-right"><i class="fa fa-edit"></i> Regresar a consulta
          </a> -->
