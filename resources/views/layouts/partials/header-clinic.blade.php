          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-4 text-center">
                    <a href="{{ url('/clinic/patients') }}">Pacientes</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="{{ url('/clinic/appointments') }}">Agenda</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="{{ url('/clinic/account/edit') }}">Perfil</a>
                  </div>
              ...
              <li class="user-footer">
                 <div class="pull-left">
                  <a href="{{ url('/clinic/account/edit') }}" class="btn btn-default btn-flat">Perfil</a>
                </div>
