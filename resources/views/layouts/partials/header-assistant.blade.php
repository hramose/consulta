    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          <notifications :appointments="{{ $newAppointments }}" url="/assistant/appointments" :read="true" :view_assistant="true" :user-id="{{ auth()->id() }}"></notifications>
          <!-- User Account Menu -->
              ...
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-4 text-center">
                    <a href="{{ url('/assistant/patients') }}">Pacientes</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="{{ url('/assistant/appointments') }}">Agenda</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="{{ url('/assistant/medics') }}">Médicos</a>
                  </div>
