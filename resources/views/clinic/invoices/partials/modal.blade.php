          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
             ...
             <div class="printers pull-left">
               ...
               <button type="button" class="btn btn-success btn-print" data-invoice data-patient tabindex="2">Imprimir</button>
              <button type="button" class="btn btn-primary btn-facturar" data-invoice data-patient tabindex="3">Guardar</button>
