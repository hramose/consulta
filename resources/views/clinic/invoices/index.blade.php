...
@section('content')
    ...
    <section class="content">
        ...
        <div class="col-md-12">
         ...
         <div>
            ...
            <a href="/clinic/invoices" class="btn btn-info">Regresar</a>
             
            <a href="/clinic/invoices/create" class="btn btn-success">Crear Factura</a>
          ...
          <div class="box box-default box-calendar">
            <div class="box-header">
              <div class="">
                  <form action="/clinic/invoices" method="GET" class="form-horizontal">
                        ...
                        @foreach($invoices as $invoice)
                          <tr>
                            ...
                            <!-- <td>
                              ...
                              <td>
                                 @if($invoice->status)
                                  <a href="/clinic/invoices/{{ $invoice->id }}/notacredito">Generar Nota Crédito</a>
                                   @else 
                                      --
                                  @endif
                              </td>
                              <td>
                                 @if($invoice->status)
                                  <a href="/clinic/invoices/{{ $invoice->id }}/notadebito">Generar Nota Debito</a>
                                 @else 
                                      --
                                  @endif
                              </td>
                               @if($office->fe)
                                  ...
                                  <td>
                                    @if($invoice->status)
                                    <a href="/clinic/invoices/{{ $invoice->id }}/download/xml">XML</a>
                                    @else 
                                      --
                                    @endif
                                  </td>
  ...
  <invoice-modal url="/clinic/invoices"></invoice-modal>
