			...
			<div class="nav-tabs-custom">
	            ...
	            <div class="tab-content">
	              	<div class="{{ isset($tab) ? ($tab =='pressure') ? 'active' : '' : 'active' }} tab-pane" id="pressure">
						...
						<pressure-control :pressures="{{ $patient->pressures()->orderBy('created_at','DESC')->get() }}" :patient_id="{{ $patient->id }}" today="{{ Carbon\Carbon::now()->toDateString() }}" time="{{ Carbon\Carbon::now()->toTimeString() }}"></pressure-control>	

				    </div>
				    <!-- /.tab-pane -->
				    <div class="{{ isset($tab) ? ($tab =='sugar') ? 'active' : '' : '' }} tab-pane" id="sugar">
					   <sugar-control :sugars="{{ $patient->sugars()->orderBy('created_at','DESC')->get() }}" :patient_id="{{ $patient->id }}" today="{{ Carbon\Carbon::now()->toDateString() }}" time="{{ Carbon\Carbon::now()->toTimeString() }}"></sugar-control>	
				    </div>
				    <!-- /.tab-pane -->
