<div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="first_name" placeholder="Nombre" value="{{ old('first_name') ?: isset($patient) ? $patient->first_name : '' }}" required>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="last_name" placeholder="Apellidos" value="{{ old('last_name') ?: isset($patient) ? $patient->last_name : '' }}">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="birth_date" placeholder="Fecha de Nacimiento" value="{{ old('birth_date') ?: isset($patient) ? $patient->birth_date : '' }}" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
