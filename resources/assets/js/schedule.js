            ...
            if(event.patient_id && event.patient)
            {
              ...
              var textAlert = 'Fecha: ' + event.start.format("YYYY-MM-DD") + ' De: ' + (event.start) ? event.start.format("HH:mm") : '' + ' a: ' + (event.end) ? event.end.format("HH:mm") : '' + officeInfoDisplay;
                ...
                if(event.office)
                {
                  ...
                  textAlert = 'Favor llamar a este número: <a href="tel:' + officeInfo.phone + '">' + officeInfo.phone + '</a> <br>Fecha: ' + event.start.format("YYYY-MM-DD") + ' De: ' + (event.start) ? event.start.format("HH:mm") : '' + ' a: ' + (event.end) ? event.end.format("HH:mm") : '' + officeInfoDisplay
                }
                element.find(".appointment-details").click(function() {
